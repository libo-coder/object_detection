...
from dataset_lb import Yolo_dataset
from cfg_lb import Cfg
from models_lb import Yolov4
...
def get_args(**kwargs):
    ...
    parser.add_argument('-keep-checkpoint-max', type=int, default=10, help='maximum number of checkpoints to keep.',
...
def init_logger(log_file=None, log_dir=None, log_level=logging.INFO, mode='w', stdout=True):
    ...
    print('log file path:' + log_file)  # 此处不能使用logging输出
